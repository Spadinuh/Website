...
<div class="container paragraph">
	...
	<div class="row">
		<div class="col-md-12">
			<p class="discription">For this project, since all my friends call me "Shams" which means "Sun" in Arabic, I wanted to create my own logo based on my name. Once that was done, I realized I could take it a step further and create my own stamp by 3d-modelling and then 3D Printing it. For this piece, I wanted to demonstrate my ability to visualize an idea, properly represent it for example to a client, and finally to execute it.</p>
		</div>		
	</div>
