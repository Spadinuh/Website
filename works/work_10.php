...
<div class="container paragraph">
	...
	<div class="row">
		<div class="col-md-12">
			<p class="discription">I designed my own portfolio website using javascript</p>
			<p class="discription">&lt; insert sc of the code &gt;</p>
		</div>		
	</div>
	...
	<div class="row">
		...
		<div class="col-md-12 link">
			<a href="../images/barstorecanada.pdf" class="link_btn" target="_blank">Click to Open My File</a>
		</div>
