...
<div class="container paragraph">
	...
	<div class="row">
		<div class="col-md-12">
			<p class="discription">Art is a representation of a society’s culture and values. It therefore doesn’t appear as a shock that women have continuously been objectified and oppressed in art. Patriarchal western societies deeming the role of women as passive and valuing qualities like being polite, a good listener and glorifying the role of the virgin, this is represented in the world of art with women often naked, with static positions for example laying on a bed or standing. Those collage highlights that subject with the male gaze being portrayed on powerless women that could not voice the way they wanted to be viewed and the message they wanted to share. I disagree with Margaret Wolfe Hungerford’s quote “Beauty is in the Eye of the Beholder”, it’s in the eye of the lawmaker, the artist, the trendsetters.</p>
		</div>		
	</div>
	
</div>
<div class="container picture_container">
	<div class="row">

		<div class="col-md-5 img">
			<img src="../images/oppression1.jpg">
		</div>
		<div class="col-md-2"></div>
		<div class="col-md-5 img">
			<img src="../images/oppression2.jpg">
		</div>
