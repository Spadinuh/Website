...
<div class="container paragraph">
	...
	<div class="row">
		<div class="col-md-12">
			<p class="discription">I made with PHP and javascript a stock website that lets you buy stock trades. I have included under the link and once you copy paste it you will be asked to register with your email adress and a password. Once you have an account set you can proceed by looking up stock quotes for example “amzn” for Amazon or “fb” for Facebook. You start with 10,000$ and as you buy shares or sell them that amount fluctuates.</p>

			<p class="link_p"><a href="http://stockxportfolio.herokuapp.com/login"> http://stockxportfolio.herokuapp.com/login </a></p>
			
			<p class="link_p text-left">Find code on GitHub:</p>
			<p class="link_p2"><a href="https://github.com/Spadinuh/Stocks">https://github.com/Spadinuh/Stocks</a></p>
